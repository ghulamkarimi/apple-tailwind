 ...
 const Carde = () => {
   return (
    <div className="bg-slate-400 flex justify-center ">
     <div className="flex bg-gray-500 p-12 w-[90vw] justify-center gap-6 rounded-2xl">
       <img className=" h-96 w-[40vw] rounded-xl " src={ima} alt="imac" />
       <span className="flex flex-col gap-24 text-white">
       <h3 className=" text-white text-xl bg-gradient-to-r hover:bg-gradient-to-l from-purple-500 to-pink-500  text-center max-md:hidden  ">{'iMac Pro 27" 5K (Late 2017) Xeon W 3.2GHz - SSD 1TB - 32GB AZERTY - French'}</h3>
