    ...
    <div className="pt-2  bg-slate-400 ">
      <section className="">
        <NavLink to="https://www.apple.com/de/shop/buy-iphone/iphone-14">
          <div className="main flex flex-col items-center h-[40vw] rounded-2xl mt-6 ">
            <span className=" ">
              <p className="flex p-[2rem]  font-bold text-black text-3xl lg:text-6xl ">
                iphone 14
              </p>
              <p className="flex pl-8 text-black font-bold text-2xl lg:text-4xl">
                The Prp Plus Ultra.
              </p>
              </span>
